...
function problemA() {
  ...
  promisifiedReadFile("poem-one/stanza-01.txt").then(
    ...
    // en caso que haya errores pasar el segunda funcion con el error como se dice que ignore errores no lo tenemos en cuenta para esta ejercicio.
  );
}
...
function problemD() {
  ...
  // promise version
  // ???
  // La base de las try catch son dos funciones primero se llama la operacion correcta con stanza y luego se mira el error el cual => es razon
